...
# ******************************************************
    ...
    elif algorithm == "ELAS_ERM":
        _hparam("weight_decay", 0, lambda r: 10**r.uniform(-5, -4))
        _hparam("alpha", 1e-3, lambda r: 10**r.uniform(-1, 5))
        _hparam("rho", 1, lambda r: r.choice([1, 0.75, 0.5, 0.25, 0]))
        _hparam("elas_penalty_anneal_iters", 500, lambda r: int(10**r.uniform(0, 4)))
